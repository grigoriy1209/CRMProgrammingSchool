...
class OrderModels(models.Model):
    ...
    alreadyPaid = models.IntegerField(validators=[MinValueValidator(100), MaxValueValidator(1000000)])
...
class CommentModels(models.Model):
    ...
    manager = models.ForeignKey(UserModel, on_delete=models.CASCADE, null=True, related_name='comments')
